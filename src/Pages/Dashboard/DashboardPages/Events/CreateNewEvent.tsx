...
// import { createEvent, CreateEventInput } from "../../../services/eventService";
  ...
  return (
    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Fill in the details below to create a new church event</p>
      </div>
            ...
            {formData.title ? (
              <>
                <div className="bg-white p-4 rounded-lg border-2 border-gray-200 mb-4">
                  <QRCode
                    value={`${window.location.origin}/check-in/${Date.now()}`}
                    size={200}
                    level="H"
                  />
                </div>
